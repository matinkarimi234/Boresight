...
def main():
    ...
    overlay_display.set_style(scale_spacing=10, scale_major_every=5, scale_major_length=20, scale_minor_length=5, scale_label_show= False, scale_tick_thickness=1)
